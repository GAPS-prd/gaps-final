...
const SideNav = () => {
  return (
    <div className="md:w-60 border-l  bg-white h-screen flex-1 fixed border-r border-zinc-200 hidden md:flex">
      <div className="flex flex-col space-y-6 w-full">
        ...
        >
          ...
          <Image className='mb-1' src={'/logo.webp'} height={28} width={28} alt='logo' />
          <span className="font-bold text-xl hidden md:flex">GAPS</span>
        </Link>
